...
<div class="login-box">
    ...
    <p class="login-box-msg">Sign in to start your session</p>
      ...
      <div class="row">
        ...
        <div class="col-xs-4 pull-right">
          <button type="submit" id="btn_login" class="btn btn-default pull-right" name="submit" value="login">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
  ...
  <!-- <center><strong>Copyright &copy; 2017 <a href="#">Asido</a>.</strong> All rights
